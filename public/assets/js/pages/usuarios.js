        ...
        columns: [
            {
                ...
                render: function (data, type) {
                    if (type === 'display') { 
                        return `<a class="btn btn-primary" href="${ base_url + 'usuarios/' + data.id + '/edit' }"><i class="fas fa-edit"></i></a>
                        <form action="${ base_url + 'usuarios/' + data.id }" method="post" class="d-inline eliminar">
